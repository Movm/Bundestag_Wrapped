...
const SURFACES = {
  ...
  dip: {
    ...
    filters: [
      ...
      { field: 'fraktion', type: 'string', values: DIP_PARTY_LONG, valueSource: 'open', note: 'bundestag_search_personen. Filtered page-spanning by the MCP because DIP has no person-faction filter. Official names are listed; GRÜNE, Gruene and B90/GR are accepted aliases for BÜNDNIS 90/DIE GRÜNEN.' },
