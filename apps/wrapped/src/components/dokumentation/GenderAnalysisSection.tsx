        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border border-blue-200 bg-blue-50 rounded-lg p-5">
              ...
              <div className="text-3xl font-mono text-blue-700 mb-1">416</div>
            ...
            <div className="border border-pink-200 bg-pink-50 rounded-lg p-5">
              ...
              <div className="text-3xl font-mono text-pink-700 mb-1">395</div>
              <div className="text-sm text-stone-600">Wörter pro Rede (Durchschnitt)</div>
            </div>
          </div>
          <div className="mt-4 bg-stone-50 rounded-lg p-4">
            <p className="text-sm text-stone-600">
              ...
              (21 Wörter mehr pro Rede).
            </p>
          </div>
        </motion.div>

        {/* Interruption Patterns - Simplified */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-5">
            ...
            <p className="text-sm text-amber-800">
              Frauen machen etwa <strong>30%</strong> der Zwischenrufe, erhalten aber einen höheren
              Anteil der Unterbrechungen relativ zu ihrer Redebeteiligung. Männer unterbrechen
              häufiger als sie selbst unterbrochen werden.
            </p>
          </div>
        </motion.div>
