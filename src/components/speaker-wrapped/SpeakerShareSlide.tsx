...
/**
 * Speaker Wrapped share slide.
 * Canvas-based sharepic generation with download/share functionality.
 */
export const SpeakerShareSlide = memo(function SpeakerShareSlide({
  speaker,
  onRestart,
      ...
      >
        ...
        >
          <canvas
            ...
            aria-label={`Sharepic für ${speaker.name}`}
          />
        </motion.div>
